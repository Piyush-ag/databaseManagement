------------------------ Week 4 Initializing Script ----------------------------
---- It is fine to see error messages from DROP TABLE at the beginning ---------
---- 9 Tables will be created as a result --------------------------------------
...
DROP TABLE BOOKAUTHOR1 CASCADE CONSTRAINTS;
DROP TABLE ORDERITEMS1 CASCADE CONSTRAINTS;
DROP TABLE CUSTOMERS1 CASCADE CONSTRAINTS;
DROP TABLE DEPT CASCADE CONSTRAINTS;
DROP TABLE EQUIP CASCADE CONSTRAINTS;
DROP TABLE ETYPES CASCADE CONSTRAINTS;
...
ALTER TABLE customers           -- for week4 only
DROP COLUMN region;             -- for week4 only
...
ShipCost NUMBER(4,2),
  ...
  CONSTRAINT orders_shipdate_ck CHECK (shipdate >= orderdate)); 
