...
DROP TABLE TESTING PURGE;
DROP TABLE WAREHOUSES PURGE;
DROP TABLE Publisher2 PURGE;
DROP TABLE Publisher3 PURGE;
...
INSERT INTO employees VALUES (7839,'KING','BEN', 'GTECH2',TO_DATE('10-NOV-06','DD-MON-YY'),10,6000,NULL);
INSERT INTO employees VALUES (8888,'JONES','LARRY','MTech2',TO_DATE('15-MAR-09','DD-MON-YY'),10,4200,7839);
INSERT INTO employees VALUES (7344,'SMITH','SAM','GTech1',TO_DATE('01-MAY-20','DD-MON-YY'),20,4900,7839);
INSERT INTO employees VALUES (7355,'POTTS','JIM','GTech1',TO_DATE('15-OCT-15','DD-MON-YY'),20,4900,7839);
INSERT INTO employees VALUES (8844,'STUART','SUE','MTech1',TO_DATE('01-MAY-12','DD-MON-YY'),10,3700,8888);
COMMIT;


----------------- Needed for SET Operator (Week 5 Part II)
